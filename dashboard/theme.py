...
# CSS-variable name aliases for use inside the pages' HTML f-strings.
...
def inject(theme: str) -> None:
    ...
    st.markdown(
        ...
        div[role="radiogroup"] label {{
            ...
            border-radius: 7px; padding: 3px 12px; margin: 0; white-space: nowrap;
        }}
        div[role="radiogroup"] label p {{
            color: var(--muted) !important; font-size: 12px; white-space: nowrap;
        }}
